...
{
    public class FormaGeometricaAdmin
    {
        private readonly IEnumerable<FormaGeometrica> _formas;
        private readonly IReporteBuilder _reporteBuilder;
        private EscribirReporte _reporte;

        public FormaGeometricaAdmin(IEnumerable<FormaGeometrica> formas, IReporteBuilder reporteBuilder)
        {
            _formas = formas;
    ...
    //    public FormaGeometricaAdmin(int tipo, decimal ancho)
    //    {
    //        Tipo = tipo;
    //        _lado = ancho;
    //    }

    //    public static string Imprimir(List<FormaGeometricaAdmin> formas, int idioma)
    //    {
    //        var sb = new StringBuilder();
